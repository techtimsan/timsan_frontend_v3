...
export default function Conference() {
    return <main>
        ...
        <section className="custom__section h-[90vh] py-auto bg-page-bg bg-cover bg-center flex items-center justify-center flex-col text-white relative">
            ...
            <div className="z-10 text-center space-y-5 sm:space-y-10 sm:w-[50vw]"><h2 className="font-semibold text-4xl sm:text-5xl">Welcome to IOTB and TIMSAN Annual National Conference Page</h2>
